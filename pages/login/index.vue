<template>
  ...
  >
    <div class="grid grid-cols-1 lg:grid-cols-2 w-full">
      ...
      <!-- OPSI 1 -->
      <!-- <div class="text-center space-y-12 my-auto">
        <h1 class="text-[#EAA825] text-4xl font-bold">ABSENSI</h1>
        ...
        <div>
          <button
            class="w-[364px] bg-[#CC6633] text-white py-3 rounded"
            @click="onToggle"
          >
            Masuk
          </button>
          <div
            ...
            class="fixed top-0 left-0 flex items-center h-screen justify-center right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto lg:inset-0 h-modal lg:h-full"
          >
            <div class="relative w-full h-full max-w-md lg:h-auto">
              <div class="relative rounded-lg shadow bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-8">
                  ...
                  <form class="space-y-6 text-left" action="#">
                    <div>
                      <label
                        for="email"
                    ...
                    <button
                      type="submit"
                      class="w-full text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-[#F7931E]"
                    >
                      Login
                    </button>
                  </form>
